<?php namespace Sabidos\MigrationsGenerator;
...
class MigrationsGeneratorServiceProviderTest extends PHPUnit_Framework_TestCase {
      ...
      ->with(
        Mockery::on(function($callback) {
          ...
          $this->assertInstanceOf(
            'Sabidos\MigrationsGenerator\MigrateGenerateCommand',
            $callback($mock)
          );
  ...
  */
  ...
  protected function get_service_provider_mock($app_mock = null)
  {
    ...
    return Mockery::mock('Sabidos\MigrationsGenerator\MigrationsGeneratorServiceProvider', [
        $app_mock
      ])
